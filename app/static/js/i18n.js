...
const DICT = {
  ja: {
    ...
    "changelog.pageTitle": "変更履歴 - ADS-B Analytics",
    "changelog.heading": "変更履歴",
    "changelog.description": "ADS-B Analyticsの主な変更を新しい順に掲載しています。",
    "changelog.v0150": "生データ受信障害の診断と対策、サイト内変更履歴、Cloudflare Access認証下でのPWAインストール修正をまとめたリリースです。",
    "changelog.v0148": "Cloudflare Access認証下でもPWA manifestへ認証Cookieを送信するよう修正し、PWAインストールを復旧しました。",
    "changelog.v0147": "生データ受信障害の原因を特定し、DockerからBeastストリームへの到達性診断と限定的なファイアウォール対策手順を追加しました。変更履歴ページを追加しました。",
    "changelog.v0146": "受信範囲3Dパネルをページ下部へ移動し、高さを2倍にしました。",
    "changelog.v0145": "ユーザー確認済みの東西反転と、距離リング・地図縮尺の不一致を修正しました。",
    "changelog.v0144": "誤ったu軸反転を戻し、3Dカメラの極角上限を調整しました。",
    "changelog.v0143": "受信範囲3Dパネルで発生した2つ目の地図ミラーリング不具合を修正しました。",
    "changelog.v0142": "等密度面が実測点より広がって見える問題を調整しました。",
    "changelog.v0141": "受信範囲3Dパネルの南北反転、高度の強調、距離リング、配色を改善しました。",
    "changelog.v0140": "受信局中心の実地図、方位計、高度目盛りを受信範囲3Dパネルに追加しました。",
  ...
  en: {
    ...
    "changelog.pageTitle": "Changelog - ADS-B Analytics",
    "changelog.heading": "Changelog",
    "changelog.description": "A reverse-chronological record of the main ADSB Analytics changes.",
    "changelog.v0150": "Consolidated the raw-data reception diagnostics and fix, the in-app changelog, and restored PWA installation behind Cloudflare Access.",
    "changelog.v0148": "Restored PWA installation behind Cloudflare Access by sending credentials when fetching the web app manifest.",
    "changelog.v0147": "Identified the raw-data outage cause and added Docker-to-Beast reachability diagnostics plus narrowly scoped firewall guidance. Added this changelog page.",
    "changelog.v0146": "Moved the 3D reception-range panel to the bottom of the page and doubled its height.",
    "changelog.v0145": "Fixed the user-confirmed east/west flip and mismatches between distance rings and map scale.",
    "changelog.v0144": "Reverted the incorrect u-axis flip and adjusted the 3D camera polar-angle limit.",
    "changelog.v0143": "Fixed a second, independent map-mirroring issue in the 3D reception-range panel.",
    "changelog.v0142": "Tuned the isosurface where it appeared wider than the measured reception points.",
    "changelog.v0141": "Improved north/south mirroring, altitude compression, distance rings, and colors in the 3D reception-range panel.",
    "changelog.v0140": "Added a receiver-centered basemap, compass, and altitude scale to the 3D reception-range panel.",
